#
# usage:
# Read("~/Workspace/Chevalley.gap/init.gi"); Read(Filename(home_dir,"load.gi")); Read(Filename(e6_dir_char3,"_init_char3.gi")); Read(Filename(e6_dir_char3,"A3A1.gi"));
#
# Read(Filename(e6_dir_char3,"A3A1.gi"));
#


label:="A_3A_1";
orb_nr:=Position(labels,label);
#orb:=AllClasses(orbs)[11];
