#
# usage:
# Read("~/Workspace/Chevalley.gap/init.gi"); Read(Filename(home_dir,"load.gi")); Read(Filename(e6_dir_char3,"_init_char3.gi")); Read(Filename(e6_dir_char3,"D4.gi"));
#
# Read(Filename(e6_dir_char3,"D4.gi"));
#
