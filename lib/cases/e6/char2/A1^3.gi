#
# usage:
# Read("~/Workspace/Chevalley.gap/init.gi"); Read(Filename(home_dir,"load.gi")); Read(Filename(e6_dir_char2,"_init_char2.gi")); Read(Filename(e6_dir_char2,"A1^3.gi"));
#
# Read(Filename(e6_dir_char2,"A1^3.gi"));
#
