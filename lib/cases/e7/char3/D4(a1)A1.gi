#
# usage:
# Read("~/Workspace/Chevalley.gap/init.gi"); Read(Filename(home_dir,"load.gi")); Read(Filename(e7_dir_char3,"init_char3.gi")); Read(Filename(e7_dir_char3,"D4(a1)A1.gi"));
#
# Read(Filename(e7_dir_char3,"init_char3.gi")); Read(Filename(e7_dir_char3,"D4(a1)A1.gi"));
#
