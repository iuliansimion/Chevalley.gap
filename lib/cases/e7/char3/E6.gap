#
# usage:
# Read("~/Workspace/Chevalley.gap/init.gap"); Read(Filename(home_dir,"load.gap")); Read(Filename(e7_dir_char3,"init_char3.gap")); Read(Filename(e7_dir_char3,"E6.gap"));
#
# Read(Filename(e7_dir_char3,"init_char3.gap")); Read(Filename(e7_dir_char3,"E6.gap"));
#
