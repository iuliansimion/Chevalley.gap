#
# usage:
# Read("~/Workspace/Chevalley.gap/init.gap"); Read(Filename(home_dir,"load.gap")); Read(Filename(e7_dir_char2,"(A3A2)(2).gap"));
#
# Read(Filename(e7_dir_char2,"(A3A2)(2).gap"));
#
