#
# usage:
# Read("~/Workspace/Chevalley.gap/init.gap"); Read(Filename(home_dir,"load.gap")); Read(Filename(e8_dir_char3,"init_char3.gap")); Read(Filename(e8_dir_char3,"A_5A_1.gap"));
#
# Read(Filename(e8_dir_char3,"init_char3.gap")); Read(Filename(e8_dir_char3,"A_5A_1.gap"));
