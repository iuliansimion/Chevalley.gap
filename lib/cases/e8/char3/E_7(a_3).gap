#
# usage:
# Read("~/Workspace/Chevalley.gap/init.gap"); Read(Filename(home_dir,"load.gap")); Read(Filename(e8_dir_char3,"init_char3.gap")); Read(Filename(e8_dir_char3,"E_7(a_3).gap"));
#
# Read(Filename(e8_dir_char3,"init_char3.gap")); Read(Filename(e8_dir_char3,"E_7(a_3).gap"));
