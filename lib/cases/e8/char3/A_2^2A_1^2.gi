#
# usage:
# Read("~/Workspace/Chevalley.gap/init.gi"); Read(Filename(home_dir,"load.gi")); Read(Filename(e8_dir_char3,"init_char3.gi")); Read(Filename(e8_dir_char3,"A_2^2A_1^2.gi"));
#
# Read(Filename(e8_dir_char3,"init_char3.gi")); Read(Filename(e8_dir_char3,"A_2^2A_1^2.gi"));
