#
# usage:
# Read("~/Workspace/Chevalley.gap/init.gap"); Read(Filename(home_dir,"load.gap")); Read(Filename(e8_dir_char2,"init_char2.gap")); Read(Filename(e8_dir_char2,"D_5(a_1)A_2.gap"));
#
# Read(Filename(e8_dir_char2,"init_char2.gap")); Read(Filename(e8_dir_char2,"D_5(a_1)A_2.gap"));
