#
# usage:
# Read("~/Workspace/Chevalley.gap/init.gi"); Read(Filename(home_dir,"load.gi")); Read(Filename(e8_dir_char2,"init_char2.gi")); Read(Filename(e8_dir_char2,"A_3^2.gi"));
#
# Read(Filename(e8_dir_char2,"init_char2.gi")); Read(Filename(e8_dir_char2,"A_3^2.gi"));
