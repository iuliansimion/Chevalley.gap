#
# usage:
# Read("~/Workspace/Chevalley.gap/init.gap"); Read(Filename(home_dir,"load.gap")); Read(Filename(e8_dir_char2,"init_char2.gap")); Read(Filename(e8_dir_char2,"E_6(a_3)A_1.gap"));
#
# Read(Filename(e8_dir_char2,"init_char2.gap")); Read(Filename(e8_dir_char2,"E_6(a_3)A_1.gap"));
