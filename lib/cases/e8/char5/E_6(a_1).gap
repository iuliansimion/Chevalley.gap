#
# usage:
# Read("~/Workspace/Chevalley.gap/init.gap"); Read(Filename(home_dir,"load.gap")); Read(Filename(e8_dir_char5,"init_char5.gap")); Read(Filename(e8_dir_char5,"E_6(a_1).gap"));
#
# Read(Filename(e8_dir_char5,"init_char5.gap")); Read(Filename(e8_dir_char5,"E_6(a_1).gap"));
