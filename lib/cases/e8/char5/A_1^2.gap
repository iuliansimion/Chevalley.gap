#
# usage:
# Read("~/Workspace/Chevalley.gap/init.gap"); Read(Filename(home_dir,"load.gap")); Read(Filename(e8_dir_char5,"init_char5.gap")); Read(Filename(e8_dir_char5,"A_1^2.gap"));
#
# Read(Filename(e8_dir_char5,"init_char5.gap")); Read(Filename(e8_dir_char5,"A_1^2.gap"));
