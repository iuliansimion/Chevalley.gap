#
# usage:
# Read("~/Workspace/Chevalley.gap/init.gi"); Read(Filename(home_dir,"load.gi")); Read(Filename(e8_dir_char5,"init_char5.gi")); Read(Filename(e8_dir_char5,"E_8(a_5).gi"));
#
# Read(Filename(e8_dir_char5,"init_char5.gi")); Read(Filename(e8_dir_char5,"E_8(a_5).gi"));
