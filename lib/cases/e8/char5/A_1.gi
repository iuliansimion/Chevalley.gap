#
# usage:
# Read("~/Workspace/Chevalley.gap/init.gi"); Read(Filename(home_dir,"load.gi")); Read(Filename(e8_dir_char5,"init_char5.gi")); Read(Filename(e8_dir_char5,"A_1.gi"));
#
# Read(Filename(e8_dir_char5,"init_char5.gi")); Read(Filename(e8_dir_char5,"A_1.gi"));
