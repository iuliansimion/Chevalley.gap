...
# cls 38: A_2A_1
#
handle38char3:=function(orbs,infos)
    local tmp1,tmp2,o,info,rep,cent,uu;
    o:=Classes(orbs)[38];
    info:=infos[38];
...
#
handle27char3:=function(orbs,infos)
    local tmp1,tmp2,o,info,rep,cent,uu;
    o:=Classes(orbs)[27];
    #o:=orbs;
    info:=infos[27];
...
#
handle20char3:=function(orbs,infos)
    local tmp1,tmp2,o,info,rep,cent,uu;
    o:=Classes(orbs)[20];
    info:=infos[20];
...
#
# cls 14: E_6(a_3) [1,4,6,15,16,17] this doesn't work in char2 
#
...
#
# cls 8: E_7(a_4) [1,4,7,13,15,16,17,23] this doesn't work in char2 
#
...
#
# cls 4: E_7(a_3) [1,4,6,7,15,16,17] this doesn't work in char2 
#
